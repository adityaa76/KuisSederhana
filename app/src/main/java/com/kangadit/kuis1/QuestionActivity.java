...
import static com.kangadit.kuis1.CategoryAdapter.CATEGORY_COLOR;
import static com.kangadit.kuis1.CategoryAdapter.CATEGORY_ID;
...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRemaningQuestionsTextView = findViewById(R.id.remaining_question);
